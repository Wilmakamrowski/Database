...
<?=template_header('ItemLog')?>

<div class="content read">
	<h2>Amend Item</h2>
	<a href="AdminItemCreate.php" class="create-Donator">Add Item</a>
	...
	<table id="myTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=$Item['created']?></td>
                <td class="actions">
                    <a href="AdminItemUpdate.php?id=<?=$Item['id']?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                    <a href="AdminItemDelete.php?id=<?=$Item['id']?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
	...
	<div class="pagination">
		<?php if ($page > 1): ?>
		<a href="AdminItem.php?page=<?=$page-1?>"><i class="fas fa-angle-double-left fa-sm"></i></a>
		<?php endif; ?>
		<?php if ($page*$records_per_page < $num_Item): ?>
		<a href="AdminItem.php?page=<?=$page+1?>"><i class="fas fa-angle-double-right fa-sm"></i></a>
		<?php endif; ?>
	</div>
</div>
