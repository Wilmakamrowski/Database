...
<?=template_header('DonatorLog')?>

<div class="content read">
	<h2>Amend Donators</h2>
	<a href="AdminDonatorLog.php" class="create-Donator">Add Donator</a>
	...
	<div class="pagination">
		<?php if ($page > 1): ?>
		<a href="AdminDonatorLog.php?page=<?=$page-1?>"><i class="fas fa-angle-double-left fa-sm"></i></a>
		<?php endif; ?>
		<?php if ($page*$records_per_page < $num_Donator): ?>
		<a href="AdminDonatorLog.php?page=<?=$page+1?>"><i class="fas fa-angle-double-right fa-sm"></i></a>
		<?php endif; ?>
	</div>
</div>
