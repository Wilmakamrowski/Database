	...
	<table id="myTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <a href="AdminAircraftUpdate.php?id=<?=$AirCraft['id']?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                    <a href="AdminAircraftDelete.php?id=<?=$AirCraft['id']?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
