...
<div class="content read">
	...
	<a href="AdminDonator.php" class="create-Donator">Add Donator</a>
	...
	<div class="pagination">
		<?php if ($page > 1): ?>
		<a href="AdminDonator.php?page=<?=$page-1?>"><i class="fas fa-angle-double-left fa-sm"></i></a>
		<?php endif; ?>
		<?php if ($page*$records_per_page < $num_Donator): ?>
		<a href="AdminDonator.php?page=<?=$page+1?>"><i class="fas fa-angle-double-right fa-sm"></i></a>
		<?php endif; ?>
	</div>
</div>
